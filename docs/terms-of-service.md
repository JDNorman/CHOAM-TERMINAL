...
- **Country** referes to: United States of America
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to C.H.O.A.M. TERMINAL's development team.
...
- **Discord Bot** refers to the C.H.O.A.M. TERMINAL Discord Bot.
